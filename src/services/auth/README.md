...
The mock login accepts a mobile number only. The mock OTP is `123456`.
...
Platform Super Admin mobile number:

- `9999999999`

Unregistered mobile numbers, incorrect OTPs, expired OTP
